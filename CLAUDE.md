...
Last updated by Task 026b extended Vedic yogas (2026-05-11, branch `development`).
...
- **Tests:** 42 test files, 437 tests + 87 subtests, all passing (Task 026b added 17 extended-yoga tests). Coverage 91.55% (`--cov=mayaastrolib --cov-fail-under=80`). **Status:** Tasks 017, 017b, 018–026, 026b all done. The only remaining follow-up is **024b** (Tajika Varsheshwara / Harsha Bala / Panchavargiya Bala / Sahams / aspects).
