...
Last updated by Task 030 KP sub-sub-lord/horary/Ruling-Planets (2026-05-11, branch `development`).
...
- **Tests:** 46 test files, 491 tests + 87 subtests, all passing. Coverage 91.88% (`--cov=mayaastrolib --cov-fail-under=80`). **Status:** Phase 2 + 027–030 done. `mayaastrolib/vedic/` = 12 modules. Remaining phase-3 depth-fill: rest of the ~50-Saham list, fully-faithful Panchavargiya scales, remaining 13 Tajika yogas, full KP horary chart, Ashtakavarga shodhana/kakshya, lesser yogas, yoga strength — Tasks 031–032.
