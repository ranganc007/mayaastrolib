...
Last updated by Task 021 Vedic ashtakavarga (2026-05-11, branch `development`).
...
- **Tests:** 35 test files, 320 tests + 87 subtests, all passing (Task 021 added 16 ashtakavarga tests; Phase 2 contribution so far: 23 + 17 + 25 + 19 + 16 = 100 new tests). Coverage 90.37% (`--cov=mayaastrolib --cov-fail-under=80`).
