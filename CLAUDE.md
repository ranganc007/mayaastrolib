...
Last updated by Task 018 Vedic nakshatras (2026-05-11, branch `development`).
...
- **Tests:** 32 test files, 259 tests + 87 subtests, all passing (Task 018 added 17 nakshatra unit tests on top of Task 017's 23 + 3 subtests). Coverage 89.13% (`--cov=mayaastrolib --cov-fail-under=80`).
