...
Last updated by Task 029 Tajika balas + aspects (2026-05-11, branch `development`).
...
- **Tests:** 45 test files, 478 tests + 87 subtests, all passing. Coverage 91.76% (`--cov=mayaastrolib --cov-fail-under=80`). **Status:** Phase 2 + 027–029 done. `mayaastrolib/vedic/` = 12 modules (added `tajika_bala`, `tajika_aspects`). Remaining phase-3 depth-fill: rest of the ~50-Saham list, fully-faithful Panchavargiya scales, remaining 13 Tajika yogas, KP sub-sub-lord/horary/Ruling-Planets, Ashtakavarga shodhana/kakshya, lesser yogas, yoga strength — Tasks 030–032.
