...
Last updated by Task 031 Ashtakavarga shodhana/kakshya (2026-05-11, branch `development`).
...
- **Tests:** 47 test files, 510 tests + 87 subtests, all passing. Coverage 91.99% (`--cov=mayaastrolib --cov-fail-under=80`). **Status:** Phase 2 + 027–031 done. `mayaastrolib/vedic/` = 12 modules. Remaining phase-3 depth-fill: rest of the ~50-Saham list, fully-faithful Panchavargiya scales, remaining 13 Tajika yogas, full KP horary chart, lesser yogas + yoga strength scoring — Task 032 + further follow-ups.
