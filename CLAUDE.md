...
Last updated by Task 019 Vedic divisional charts (2026-05-11, branch `development`).
...
- **Tests:** 33 test files, 284 tests + 87 subtests, all passing (Task 019 added 25 divisional-chart tests). Coverage 89.75% (`--cov=mayaastrolib --cov-fail-under=80`).
