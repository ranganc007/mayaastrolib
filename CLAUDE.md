...
Last updated by Task 024b Tajika balas/Sahams (2026-05-11, branch `development`).
...
- **Tests:** 43 test files, 450 tests + 87 subtests, all passing (Task 024b added 21 Tajika-balas tests). Coverage 91.68% (`--cov=mayaastrolib --cov-fail-under=80`). **Status:** Phase 2 complete — all spec modules (017–026) plus the named follow-ups (017b extra ayanamsas, 024b Tajika balas-core, 026b extended yogas) shipped. `mayaastrolib/vedic/` = 10 modules. Remaining is phase-3 depth-fill (full 50-Saham table, Harsha/Panchavargiya Bala, Tajika aspects, KP sub-sub-lord/horary/Ruling-Planets, Ashtakavarga shodhana/kakshya, lesser yogas, yoga strength) — all scoped in the relevant CHANGELOG entries / module docstrings.
