...
Last updated by Task 025 Vedic KP sub-lords (2026-05-11, branch `development`).
...
- **Tests:** 41 test files, 420 tests + 87 subtests, all passing (Task 025 added 14 KP tests). Coverage 91.42% (`--cov=mayaastrolib --cov-fail-under=80`). **Status:** Tasks 017, 017b, 018–026 all done — the full spec module list is shipped. Remaining follow-ups: **024b** (Tajika Varsheshwara/balas/Sahams/aspects) and extended yogas (Raja/Dhana/Vipareeta/Neecha-Bhanga/Kemadruma).
