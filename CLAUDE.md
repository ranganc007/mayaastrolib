...
Last updated by Task 026 Vedic yogas (2026-05-11, branch `development`).
...
- **Tests:** 39 test files, 395 tests + 87 subtests, all passing (Task 026 added 23 yoga tests; Phase 2 contribution: 23+17+25+19 [P0] + 16+22+17 [P1] + 13 [024 tajika core] + 23 [026 yogas] = 175 new tests). Coverage 91.18% (`--cov=mayaastrolib --cov-fail-under=80`). **Note:** Tasks 017–024 and 026 are done; **Task 025 (KP sub-lords) is the only remaining spec module**, plus follow-ups 017b (extra ayanamsas), 024b (Tajika balas/Sahams), and the extended-yogas follow-up.
