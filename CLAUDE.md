...
Last updated by Task 017b additional ayanamsas (2026-05-11, branch `development`).
...
- **Tests:** 40 test files, 406 tests + 87 subtests, all passing (Task 017b added 11 ayanamsa-variant tests). Coverage 91.24% (`--cov=mayaastrolib --cov-fail-under=80`). **Status:** Tasks 017, 017b, 018–024, 026 done. Remaining: **025 (KP sub-lords)** and follow-ups **024b** (Tajika balas/Sahams/aspects) and extended yogas.
