...
FORMULAS[PARS_SPIRIT] = [[const.MOON, const.SUN, const.ASC], [const.SUN, const.MOON, const.ASC]]
...
FORMULAS[PARS_FATHER] = [[const.SUN, const.SATURN, const.ASC], [const.SATURN, const.SUN, const.ASC]]

FORMULAS[PARS_MOTHER] = [[const.VENUS, const.MOON, const.ASC], [const.MOON, const.VENUS, const.ASC]]
