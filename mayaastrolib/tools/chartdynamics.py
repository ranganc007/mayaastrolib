...
class ChartDynamics:
    ...
    def aspectsByCat(self, ID, aspList):
        ...
        """
        res = {const.APPLICATIVE: [], const.SEPARATIVE: [], const.EXACT: [], const.NO_MOVEMENT: []}
        ...
        for elem in valid:
            ...
            if role["inOrb"]:
                ...
                res[movement].append({"id": objB.id, "asp": asp.type, "orb": asp.orb})
    ...
    def immediateAspects(self, ID, aspList):
        ...
        return (separations[0] if separations else None, applications[0] if applications else None)
